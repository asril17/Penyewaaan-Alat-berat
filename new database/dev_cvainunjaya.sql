...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 01 Jul 2020 pada 01.03
...
(4, 'SPR-003', 'Asril', '123123123, 34234, 4354354', 'sadsd', 0, 200000),
...
--
ALTER TABLE `transaksi_detail`
  MODIFY `id_trans_detail` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;

--
-- AUTO_INCREMENT untuk tabel `transaksi_detail_tambahan`
--
ALTER TABLE `transaksi_detail_tambahan`
  MODIFY `id_tambahan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;

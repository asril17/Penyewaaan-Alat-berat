                ...
                <div class="row" >
                    <div class="col-sm-6">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <select name="" id="" class="form-control alat_berat unique">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input readonly type="text" class="form-control harga_umum" name=""> 
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-sm-4">
                            ...
                            <div class="col-sm-8">
                                <input readonly type="text" class="form-control harga_khusus" name="">
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6">
...
<script>
    ...
    $('.pegawai').change(function(event) {
        var pegawaiID = $(this).val(), hargaPegawai = 0;
        if (pegawaiID != 1) {
            $.ajax({
    ...
    $('#tambah').click(function(event) {
        ...
        var form  = $('form[name="myForm"]'), checkVal = [],
